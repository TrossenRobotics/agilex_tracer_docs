...
project = 'AgileX TRACER Documentation'
...
html_title = "AgileX TRACER Documentation"
...
html_logo = "_images/logo_tracer.png"
...
html_context = {
    ...
    'github_repo': 'agilex_tracer_docs', # Repo name
...
htmlhelp_basename = 'AgileXTRACERDocumentation'
